...
const Bubbler = () => {
  ...
  const calculateValues = () => {
    const totolValues = Number(N2.current.value) + Number(H2.current.value);
    setValue(totolValues);
  };
  ...
  return (
    <div>
      <h1 className="text-center font-bold text-slate-700 mt-2">Bubbler</h1>
      <div className="flex">
          ...
          <div>
            ...
            <div className="flex justify-between my-2">
              ...
              <div>
                <input
                  type="text"
                  className="border-2 border-slate-300 rounded-md p-1 mr-2"
                  value=""
                  disabled
                />
                <label>cc/min</label>
