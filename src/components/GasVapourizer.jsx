  ...
  return (
    <div className="m-2 flex">
      <div className="w-8/12 h-[80vh] border-2 flex border-2 border-black ml-1">
        ...
        <div className="ml-5">
          ...
          <div className="flex gap-2">
            ...
            <button className="border-2 border-black px-4 py-1">H2</button>
            ...
            <div>
              ...
              <div className="flex justify-between w-60 font-bold ml-4">
                ...
                <div className="bg-yellow-300 w-16 text-center">
                  ...
                  <p>200</p>
                  <p>cc/min</p>
                  <p className="bg-gray-400 py-1">759</p>
                  <p>1</p>
                  <p>1</p>
                  <p>0</p>
                  <p>850</p>
                  <p className="bg-gray-400 relative top-4">0</p>
                  <p className="bg-gray-400 py-2 relative top-3">0</p>
                </div>
              ...
              <div className="absolute top-[264px] bg-gray-400 h-8 w-[280px] -z-10"></div>
              <div className="absolute top-[408px] bg-gray-400 h-16 w-[280px] -z-10"></div>
              ...
              <div className="relative top-16 -left-20">
                <p>Vaporizer Mode</p>
                <p>T wetter and P wetter is disabled</p>
              </div>
            </div> 
            <div>
              <h3 className="flex relative items-center mt-1 text-base pb-2 pt-6">
        ...
        <div className="h-[1px] bg-black w-[630px] absolute top-44 rotate-12 right-[420px]"></div>
        <div className="h-[1px] bg-black w-[230px] absolute top-[275px] rotate-45 right-[550px]"></div>
      ...
      <div className="w-4/12  relative left-2">
        <h3 className="font-bold text-xl">Vapourizer Mode</h3>
